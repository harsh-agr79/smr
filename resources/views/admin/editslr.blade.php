...
@section('main')
    ...
    <form enctype="multipart/form-data" id="createform" action="{{ route('admin.editslr') }}" method="post">
        @csrf
        <div class="mp-card" style="margin-top: 20px;">
            <div class="row" style="margin:0; padding: 0;">
                <div class="input-field col s6" style="margin:0; padding: 5px;">
                    <input type="date" class="inp browser-default black-text" name="date" value="{{ date('Y-m-d', strtotime($slr[0]->date)) }}"
                        required>
                </div>
                <div class="input-field col s6" style="margin:0; padding: 5px;">
