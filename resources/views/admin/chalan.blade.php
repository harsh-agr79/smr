...
@section('main')
                        ...
                        <td>
                            <form id="{{ $item->order_id }}deliverform">
                                <label>
                                    ...
                                    <input id="{{ $item->order_id . 'deliver' }}" {{ $dis }} type="checkbox"
                                        name="delivered" @if ($stat != 'deep-purple') disabled @endif
                                        onchange="updatedeliver({{ $item->order_id }})" />
                                    <span id="{{ $item->order_id . 'deliverspan' }}">
                                        @if ($stat != 'deep-purple')
                                            Can't Deliver
                                        @else
                                            Deliver
    ...
    <script>
        ...
        function opendetail(order_id, seen) {
            ...
            window.open('/chalandetail/' + order_id, "_self");
